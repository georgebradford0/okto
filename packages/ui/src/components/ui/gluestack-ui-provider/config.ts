...
export const config = {
  light: vars({
    /* Primary — okto brand teal (modern neutral + brand accent) */
    '--color-primary-0': '240 253 250',
    '--color-primary-50': '204 251 241',
    '--color-primary-100': '153 246 228',
    '--color-primary-200': '94 234 212',
    '--color-primary-300': '45 212 191',
    '--color-primary-400': '20 184 166',
    '--color-primary-500': '13 148 136',
    '--color-primary-600': '15 118 110',
    '--color-primary-700': '17 94 89',
    '--color-primary-800': '19 78 74',
    '--color-primary-900': '6 56 54',
    '--color-primary-950': '3 36 35',
    ...
    /* Typography — cool slate for crisp, professional text */
    '--color-typography-0': '252 253 254',
    ...
    '--color-indicator-primary': '13 148 136',
    '--color-indicator-info': '83 153 236',
    '--color-indicator-error': '185 28 28',
  }),
  dark: vars({
    /* Primary — okto brand teal, brightened for dark surfaces */
    '--color-primary-0': '4 47 46',
    '--color-primary-50': '6 78 74',
    ...
    '--color-primary-900': '224 252 245',
    '--color-primary-950': '240 253 250',
    ...
    /* Typography — cool slate, inverted for dark surfaces */
    ...
    '--color-typography-950': '252 253 254',
